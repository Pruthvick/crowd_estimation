...
PART_A = r"C:\Users\HP\crowd_estimation\ShanghaiTech_Crowd_Counting_Dataset\part_A_final\train_data"
...
X, y = load_data(PART_A)
print("Loaded Part-A:", X.shape, y.shape)
...
model.save("model_A_dense.h5")
print("💾 Saved model_A_dense.h5")
